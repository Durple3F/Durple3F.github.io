const pokemonMoveData = {
	...
	//Shifts the board back and forth
	"Hydro Vortex": {
		name: "Hydro Vortex",
		type: "Water",
		category: "Physical",
		...
		energy: {},
		sounds: {
			"part1": "src/audio/attacks/Hydro Vortex part 1.mp3",
			"part2": "src/audio/attacks/Hydro Vortex part 2.mp3",
			"part3": "src/audio/attacks/Hydro Vortex part 3.mp3",
		},
		effects: [
			{ type: "play-sound", name: "part1", wait: true },
			{ type: "play-sound", name: "part3", waitBeforeFinishMove: true },
			{ type: "z-move-animation", animationType: "Water", resolveOn: "wait", waitBeforeFinishMove: true, durations: {
				"expand": 3000,
				"wait": 8500,
				"shrink": 1000
			} },
			{ type: "damage", damageMult: 1/15, delay: 0 },
			{ type: "get-side-number", left: 1, right: -1 },
			{ type: "load-value", value: 0 },
			{ type: "select-all-tiles" },
			{ type: "shift-tiles", selection: -1, xOffset: -3, yOffset: -2, duration: 500 },

			{ type: "damage", damageMult: 2/15, delay: 0 },
			{ type: "get-side-number", left: -2, right: 2 },
			{ type: "load-value", value: 0 },
			{ type: "select-all-tiles" },
			{ type: "shift-tiles", selection: -1, xOffset: -3, yOffset: -2, duration: 700 },

			{ type: "damage", damageMult: 3/15, delay: 0 },
			{ type: "get-side-number", left: 3, right: -3 },
			{ type: "load-value", value: 0 },
			{ type: "select-all-tiles" },
			{ type: "shift-tiles", selection: -1, xOffset: -3, yOffset: -2, duration: 800 },

			{ type: "damage", damageMult: 4/15, delay: 0 },
			{ type: "get-side-number", left: -4, right: 4 },
			{ type: "load-value", value: 0 },
			{ type: "select-all-tiles" },
			{ type: "shift-tiles", selection: -1, xOffset: -3, yOffset: -2, duration: 800 },

			{ type: "damage", damageMult: 5/15, delay: 0 },
			{ type: "get-side-number", left: 5, right: -5 },
			{ type: "load-value", value: 0 },
			{ type: "select-all-tiles" },
			{ type: "shift-tiles", selection: -1, xOffset: -3, yOffset: -2, duration: 800 },
		]
